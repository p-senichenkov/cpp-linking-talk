...
#line 3 "/home/petua/linking-talk/src/language-linkage/inter-language-linking/go-main.go"
...
void
_cgo_6e1e6c7825d1_Cfunc_sort_range(void *v)
{
	struct {
		int* p0;
		int* p1;
	...
	_cgo_tsan_acquire();
	sort_range(_cgo_a->p0, _cgo_a->p1);
	_cgo_tsan_release();
}
